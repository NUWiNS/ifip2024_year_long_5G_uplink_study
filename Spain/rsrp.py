...
plt.grid(True)
# plt.legend()
plt.savefig("Plots/Spain_rsrp_Mobility_LTE.png", format="png", dpi=300)
plt.show()
...
plt.xlim([-130,-50])
plt.grid(True)
plt.savefig("Plots/Spain_rsrp_Mobility_5G.png", format="png", dpi=300)
plt.show()
...
plt.xlim([-130,-50])
plt.grid(True)
plt.savefig("Plots/Spain_rsrp.png", format="png", dpi=300)
