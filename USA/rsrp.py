...
# Custom function to extract keys and values from the cell_info_data column
...
### 
# Plot RSRP wrt Technology CA


plt.figure(figsize=(10,6))

all_values = [value for sublist in expanded_data_ca['MeanRsrp'] for value in sublist]
all_values_5g = [value for sublist in expanded_data_ca['MeanSsrsrp'] for value in sublist]
...
plt.xlim([-130,-50])
plt.grid(True)
plt.savefig("Plots/USA_ca_rsrp.png", format="png", dpi=300)


### 
# Plot RSRP wrt Technology MA


plt.figure(figsize=(10,6))

all_values = [value for sublist in expanded_data_ma['MeanRsrp'] for value in sublist]
all_values_5g = [value for sublist in expanded_data_ma['MeanSsrsrp'] for value in sublist]
...
plt.xlim([-130,-50])
plt.grid(True)
plt.savefig("Plots/USA_ma_rsrp.png", format="png", dpi=300)
